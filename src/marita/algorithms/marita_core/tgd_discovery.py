...
from marita.utils.relation_names import format_relation_reference
...
_MARITA_LOG_DIR = Path(os.environ.get("MARITA_LOG_DIR", "logs"))
_MARITA_LOG_DIR.mkdir(parents=True, exist_ok=True)

logging.basicConfig(
    filename=str(_MARITA_LOG_DIR / "tgd_computation.log"),
    level=logging.INFO,
