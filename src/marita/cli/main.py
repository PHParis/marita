...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(prog="marita", description="MARITA command line interface")
    ...
    audit_parser = subparsers.add_parser("audit", help="Audit competitor rule coverage by MARITA")
    ...
    audit_parser.add_argument("--target", default="MARITA")
    ...
    paper_parser.add_argument("--smtp-password-env", default="MARITA_SMTP_PASSWORD")
    ...
    if args.command == "paper-benchmark":
        ...
        if args.smtp_password_env != "MARITA_SMTP_PASSWORD":
