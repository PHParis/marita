...
from marita.audit.runner import get_audit_status


def parse_arguments(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Audit competitor rule coverage by MARITA.")
    ...
    parser.add_argument("--target", default="MARITA", help="Target algorithm to compare against.")
    parser.add_argument(
        "--competitors",
        default="AMIE3,MATILDA,SPIDER,POPPER",
        help="Comma-separated competitor algorithms to audit.",
    )
    parser.add_argument("--settings", default=None, help="Optional YAML config to read MARITA audit bounds from.")
