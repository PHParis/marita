...
from marita.audit.amie_translation import write_mapping_manifest
from marita.database.data_exporter import DataExporter
from marita.database.database_connection_manager import DatabaseConnectionManager
from marita.database.foreign_keys import normalise_foreign_key_targets
from marita.database.index_manager import IndexManager
from marita.database.query_utility import QueryUtility
...
class AlchemyUtility:
    ...
    def __init__(
        ...
        setup_loggers(log_dir=os.environ.get("MARITA_LOG_DIR", "logs"))
